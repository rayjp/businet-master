 ...
 */
{
	...
	const tooltips = Array.from(document.querySelectorAll('.tooltip1'));
	...
	class Tooltip1 {
		constructor(el) {
			...
			this.DOM.trigger = this.DOM.el.querySelector('.tooltip1__trigger');
			this.DOM.triggerSpan = this.DOM.el.querySelector('.tooltip1__trigger-text');
			this.DOM.base = this.DOM.el.querySelector('.tooltip1__base');
			this.DOM.shape = this.DOM.base.querySelector('.tooltip1__shape');
			if( this.DOM.shape ) {
			...
			this.DOM.deco = this.DOM.base.querySelector('.tooltip1__deco');
			this.DOM.content = this.DOM.base.querySelector('.tooltip1__content');

			this.DOM.letters = this.DOM.content.querySelector('.tooltip1__letters');
			if( this.DOM.letters ) {
	...
	const init = (() => tooltips.forEach(t => new Tooltip1(t)))();
};